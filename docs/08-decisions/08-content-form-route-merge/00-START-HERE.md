...
6. [06-구현결과.md](06-구현결과.md) — **계획과 다른 점은 여기 있다. 먼저 봐도 된다**

> **2026-08-09 추가** — 08-06에 열어 둔 마지막 항목(저장 경로)이 닫혔다.
> 병합한 라우트 11개 전부에서 추가·수정 저장이 실제로 동작하고, `past-programs`
> 갤러리의 추가·삭제도 확인됐다. 운영 DB를 건드리지 않은 방법은 06 §3-3.
