...
> **상태: 완료 (2026-08-06) — 강제로 적용됨.**
> Report-Only 2026-08-05 → 강제 2026-08-06. 전환 근거와 실측은
> [04-강제전환.md](04-강제전환.md).
...
4. [04-강제전환.md](04-강제전환.md) — **강제로 바꾼 근거와 실측** (2026-08-06)

## 착수 시점의 상태 — 아래 표는 **2026-08-05 이전** 이야기다
...
지금은 전역 CSP가 `proxy.ts`에서 **강제로** 걸린다. 현재 상태는
[docs/07-dev/14](../../07-dev/14-CSP-정책과-적용.md)를 본다.
