...
02        홈 4차 수정 요청
03 ~ 07   최종 수정 요청서            ← 확정 카피의 출처
08 ~ 11   ver3 기획서                 ← 그 앞 단계
```

특히 **WHY KPOPSOFT 레이더**는 세 문서가 각각 다르게 지시한다.
`01` → `02 §3` → `06` 순으로 덮어썼으므로 **01이 최종**이다.
...
| 6 | [06-최종수정요청-why-레이더.md](06-최종수정요청-why-레이더.md) | WHY 레이더 **구버전** — 01과 충돌 시 01을 따른다 |
| 7 | [07-최종수정요청-프로세스-문의-푸터.md](07-최종수정요청-프로세스-문의-푸터.md) | 프로젝트 진행 방식, 문의 폼, Footer, 반응형 점검 |
| 8 | [08-ver3-변경요약과-구조.md](08-ver3-변경요약과-구조.md) | ver2→ver3 변경 요약, 7섹션 구조, IA 개정 이력 |
| 9 | [09-ver3-header-hero-핵심비즈니스.md](09-ver3-header-hero-핵심비즈니스.md) | Header 메뉴/CTA, Hero 카피, 핵심 비즈니스 3분할 |
| 10 | [10-ver3-통계바와-포트폴리오.md](10-ver3-통계바와-포트폴리오.md) | 통계바 4지표, 포트폴리오 필터·이미지 원칙 |
| 11 | [11-ver3-contact-footer-완료조건.md](11-ver3-contact-footer-완료조건.md) | CONTACT 문의 유형, 앵커 이동, Footer, 완료 조건 |

코드 주석의 `docs/02-home/ §SECTION NN`은 ver3 기획서의 섹션 번호다 —
`01·02·03` → 9번, `04·05` → 10번, `06·07` → 11번.
...
- ver2 원본(대체됨) — [../99-archive/home-ver2/00-START-HERE.md](../99-archive/home-ver2/00-START-HERE.md)
