...
- Responsive/hybrid behavior: since docs/07-dev/01-기술스펙.md calls for the web app to behave well as a hybrid/app-like experience, test at minimum mobile (375px), tablet (768px), and desktop (1440px) widths — check that mobile isn't just a shrunk desktop layout (per docs/04-design-system/12-모바일과-접근성.md) and that nothing overflows or clips.
