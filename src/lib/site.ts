 ...
 *
 * INSIGHTS는 ver2에서 메뉴에서 빠졌고, 이후 상세 라우트와 데이터까지
 * 정리했다(사용자 결정). 되살릴 계획이 생기면 새로 만드는 편이 빠르다.
 */
/*
...
/**
 * 문의 폼 유형 + 세부 유형 (docs/99-archive/01-초기-16섹션-기획서.md §15, docs/06-admin/ §문의 폼 옵션 관리).
 *
