...
> **상태: 완료 (2026-08-03).** 안 A(앱에서 걷어내기)로 고쳤고, 운영 DB에서
> 저장이 실제로 되는 것을 확인했다 — 새 컬럼 집합으로 update·insert 성공,
> `is_published`를 얹은 대조군은 여전히 `PGRST204` 거부.
> 기록: [docs/07-dev/10-작업로그-2026-08-03.md](../../docs/07-dev/10-작업로그-2026-08-03.md)
